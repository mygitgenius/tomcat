...
<%
	...
	Object[] result = ActionLogDAO.getInstance().getLogList("admin", reason, pageno, resultCount);
%>
      ...
      <TABLE class=guide cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR>
          <TD><A onclick="parent.location='../index.htm'; return false;" 
            href="#">后台管理首页</A>&nbsp;&raquo;&nbsp;后台管理记录</TD></TR>
	  </TBODY></TABLE><BR>
	<FORM id="frmsearch" name="frmsearch" onSubmit="checkfields(this); return false;" action="./log_admin_action.jsp" method=post>
	<input type="hidden" name="page" value="<%= pageno %>">
      <TABLE class=info_tb cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
        <TR class=header>
          <TD colSpan=3>后台管理记录&nbsp;-&nbsp; 过滤条件</TD></TR>
...
%>
      <TABLE class=info_tb cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR class=header>
          <TD width="15%">操作者</TD>
          <TD width="10%">用户组</TD>
          <TD width="15%">IP 地址</TD>
          <TD width="18%">时间</TD>
          <TD width="15%">动作</TD>
          <TD width="27%">备注</TD></TR>
<%
...
%>	  
        <TR align=middle>
          ...
          <TD class=altbg1><%= (String)record.get("ACTION") %></TD>
          <TD class=altbg2><%= (String)record.get("REMARK") %>&nbsp;</TD></TR>
<%
		}
	}
%>		  
